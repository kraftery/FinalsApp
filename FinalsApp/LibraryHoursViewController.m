...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [self.navigationController pushViewController:libraryScreen animated:YES];
        ...
        UIAlertView *errorView = [[UIAlertView alloc] initWithTitle:@"NETWORK ERROR:" message:@"Seems like your internet is slow, Try again" delegate:self cancelButtonTitle:@"Dismiss" otherButtonTitles:nil, nil];
        [errorView show];
    }
}
