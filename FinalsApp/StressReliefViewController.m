...
- (void)viewDidLoad
{
    ...
    NSURLRequest *request = [NSURLRequest requestWithURL:[NSURL URLWithString:@"http://mobileappdevelopersclub.com/shellp/stressRelief.txt"] cachePolicy:NSURLRequestUseProtocolCachePolicy timeoutInterval:60.0];
